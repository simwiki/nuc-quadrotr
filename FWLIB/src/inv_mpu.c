...
#if defined MOTION_DRIVER_STM32
#include "stm32f4xx.h" 
...
#define get_ms      Get_Sys_ms 
static  int reg_int_cb(struct int_param_s *int_param)
{
    return STM32_EXTI_cb(int_param->GPIOx, int_param->GPIO_Pin, int_param->EXTI_Trigger);
} 
